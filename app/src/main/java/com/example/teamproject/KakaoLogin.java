...
//                session.addCallback(new SessionCallback());
                Toast.makeText(KakaoLogin.this, "로그인 시도합니다.", Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent(KakaoLogin.this, Mainpage.class);
//                startActivity(intent);
    ...
    public class SessionCallback implements ISessionCallback {
        ...
        //성공하면 mainpage에 화면 전환
        protected void redirectSignupActivity() {

            final Intent intent = new Intent(KakaoLogin.this, Mainpage.class);
            startActivity(intent);
            finish();
        }
